...
@XmlType(name = "employee", propOrder = { "id", "firstname", "lastname", "jobtitle", "email" })
public class Employee {
	...
	public Employee(int id, String firstname, String lastname, String jobtitle, String email) {
		super();
		this.id = id;
